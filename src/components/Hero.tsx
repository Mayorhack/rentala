...
const Hero = () => {
  return (
    <div className="bg-hero bg-cover bg-no-repeat bg-fixed bg-center pb-40">
      <div className="container">
        <Navbar />
        <div className="flex flex-col md:flex-row items-center my-4 lg:gap-40 md:gap-20">
          <h1 className="text-4xl md:text-[52px] text-white text-center font-bold capitalize md:leading-[70px] lg:w-1/2">
            The most affortable place to stay in the san franciso bay area
          </h1>
          <div className="">
            <Image src={map} alt="map" className="w-full" />
            <Card className="py-3 px-4 flex">
              <>
                <ReactSelect
                  options={[
                ...
                <ReactSelect
                  ...
                  id="neigh"
                />
                <button className="inline-block bg-[#23A6F0] p-5 rounded-r">
                  <svg
                    width="17"
                    height="16"
                    viewBox="0 0 17 16"
